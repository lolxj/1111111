...
<div class="data_list">
		...
		<form name="myForm" class="form-search" method="post" action="dormBuild?action=search">
				...
				<span class="data_search">
					宿舍楼名称:&nbsp;&nbsp;<input id="s_dormBuildName" name="s_dormBuildName" type="text"  style="width:120px;height: 30px;" class="input-medium search-query" value="${s_dormBuildName }">
			...
			<table class="table table-striped table-bordered table-hover datatable">
				...
				<!--用于遍历集合或迭代指定的次数-->
					...
					<tr>
						...
						<td><button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='dormBuild?action=manager&dormBuildId=${dormBuild.dormBuildId }'">宿舍管理员</button>&nbsp;
