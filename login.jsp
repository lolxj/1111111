...
<%@ page import="com.java.model.DormManager" %>
...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
		<p align="center" style="padding-top: 1px;">欢迎使用学生宿舍管理系统 </p>
      </form>
</div>
</body>
</html>