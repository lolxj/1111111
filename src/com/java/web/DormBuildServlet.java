...
import com.java.dao.DormBuildDao;
import com.java.model.DormBuild;
import com.java.model.DormManager;
...
public class DormBuildServlet extends HttpServlet{
	...
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response)//处理HTTP协议GET请求的doGET()方法
			throws ServletException, IOException {
		this.doPost(request, response);
	}

	@Override
	protected void doPost(HttpServletRequest request, HttpServletResponse response)//POST请求的doPost()方法
			throws ServletException, IOException {
